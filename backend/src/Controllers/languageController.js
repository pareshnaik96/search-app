const languageModel = require('../Models/countrylanguageModel')


//================================ get country language controller =======================================================//


const getCountryByLanguage = async function (req, res) {
    ...
    try {
        ...
        let getDetails = await languageModel.aggregate([
            {
                $lookup: {
                    from: "countries",
        ...
        return res.status(200).send({ status: true, message: "country language get successfully", docs: getDetails })
    } catch (error) {
